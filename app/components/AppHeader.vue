...
const props = defineProps<{
  /**
   * Prefix for the fragment links. Empty for the homepage (same-page scroll),
   * "/" for other pages so the navigation returns to the homepage sections.
   */
  base?: string;
}>();

const base = computed(() => props.base ?? "");
// Logo returns to the top of the homepage. On the homepage itself a plain hash
// keeps it a same-page scroll; elsewhere it navigates back home.
const homeHref = computed(() => (props.base ? props.base : "#"));
</script>
